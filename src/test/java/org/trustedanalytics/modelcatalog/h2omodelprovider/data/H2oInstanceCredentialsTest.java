...
public class H2oInstanceCredentialsTest {
  ...
  public void setUp() {
    ...
    h2oInstanceCredentials1.setGuid(uuid.toString());
    h2oInstanceCredentialsEqualTo1.setGuid(uuid.toString());
    h2oInstanceCredentialsNotEqualTo1.setGuid(UUID.randomUUID().toString());
  }
